...
START_RELOC_NUMBERS (elf_arc_reloc_type)
    ...
    RELOC_NUMBER (R_ARC_TLS_GD_DEF ,0x48)
    RELOC_NUMBER (R_ARC_TLS_IE_GOT, 0x49)
    RELOC_NUMBER (R_ARC_TLS_DTPOFF_S9, 0x4a)
    RELOC_NUMBER (R_ARC_TLS_LE_S9,  0x4b)
    RELOC_NUMBER (R_ARC_TLS_LE_32,  0x4c)
